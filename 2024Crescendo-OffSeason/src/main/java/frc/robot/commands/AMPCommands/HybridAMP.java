...
public class HybridAMP extends Command{
    ...
    public double _Omega = 0., _controllerX = 0., _controllerY = 0., _controllerXOffset = 0., _controllerYOffset = 0.;
    public HybridAMP(int _ButtonID, int _ExecuteButtonID)
    {
